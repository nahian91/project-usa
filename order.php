         ...
         <div class="col-12 col-sm-4">
            <div class="order__summary">
               ...
               <ul>
                  ...
                  <li class="order__summary-border">
                     <span>Total</span>
                     <span>$88.00</span>
                  </li>
               </ul>
               <div class="order__payment">
                  <h4 class="order__summary-title">Payment Method</h4>
                  <div class="order__payment-single">
